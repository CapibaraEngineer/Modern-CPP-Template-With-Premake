...
#   4. Self-deletes: removes configure.sh and this script.
#
# Usage: ./cleanup-template.sh [--yes]
...
echo "           reset README.md, and delete configure.sh + this script."
...
# --- 4. Self-delete: template setup is done ---
rm -f -- "$SCRIPT_DIR/configure.sh" "$SCRIPT_DIR/cleanup-template.sh"
echo "Deleted configure.sh and cleanup-template.sh."
